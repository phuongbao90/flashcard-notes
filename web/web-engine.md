...
const objB = {};
objB.y = 2;
objB.x = 1; // Different hidden class structure!
```
...
- Smooth Scrolling / Off-Main-Thread Animations: When user scrolls or triggers transform animations, the Compositor Thread directly manipulates compositor layers and generates frame commands without waiting for JS execution on the Main Thread.
